...
WHALE_GATE = 1.4          # volum instituțional clar (era 3.0)
SCORE_GATE = 85.0         # consens maxim (era 70)
RISK_PCT = 0.02  # 2% equity per trade (mai conservator pentru swing)
MIN_LOTS, MAX_LOTS = 0.10, 1.00  # FIX 1.00 lot = ~100$/pip
ATR_SL_MULT = 1.0         # SL strâns (era 1.5)
RR = 2.0                  # TP = 2x SL
COOLDOWN_HOURS = 2  # Cooldown de 24h (un trade pe zi)
MAX_PER_DAY = 999999  # Maxim 1 trade pe zi
...
if __name__ == "__main__":
    log("="*60)
    log("=== G4Trade BETA TREND v1.0 (Ultra-Selective) ===")
    _load_state()
