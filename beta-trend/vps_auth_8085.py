...
redirect_uri = "http://187.77.64.99:8085/callback"
...
class AuthHandler(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        if self.path.startswith('/callback?code='):
            ...
            self.end_headers()
            html_response = "<h1 style='font-family: sans-serif; color: green;'>SUCCES! Poti inchide aceasta fereastra.</h1><p>VPS-ul a procesat token-ul automat pe portul 8085.</p>"
            self.wfile.write(html_response.encode('utf-8'))
            
            print("\n[+] Cod primit! Se obtine token-ul de la cTrader...")
...
PORT = 8085
print("="*70)
print("SERVERUL VPS ASCULTA ACUM PE PORTUL 8085 (SIGUR, FARA CONFLICTE)")
print("="*70)
...
print("3. VPS-ul va face restul automat.\n")
